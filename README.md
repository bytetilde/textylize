...
- use your own pollinations.ai key

use on [vercel](https://textylize.vercel.app/)

## usage

1. type or paste text into the editor
2. click **stylize**
3. tap a style card to rewrite
4. copy the result

## stack

vanilla HTML/CSS/JS deployed on [vercel](https://vercel.com/)
